    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="12">
                    <el-form-item v-if="type!='info'"  class="input" label="预约日期" prop="fangjianOrderTime">
                        <el-date-picker
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="预约备注" prop="fangjianOrderText">
                        <el-input type="textarea"  :readonly="ro.fangjianOrderText" v-model="ruleForm.fangjianOrderText" placeholder="预约备注"></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.fangjianOrderText" label="预约备注" prop="fangjianOrderText">
                            <span v-html="ruleForm.fangjianOrderText"></span>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="订单状态" prop="fangjianOrderTypes">
                        <el-select v-model="ruleForm.fangjianOrderTypes" :disabled="ro.fangjianOrderTypes" placeholder="请选择订单状态">
                            <el-option
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="订单状态" prop="fangjianOrderValue">
