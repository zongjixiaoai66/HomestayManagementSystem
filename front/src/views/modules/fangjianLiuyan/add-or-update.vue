    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="评论/投诉内容" prop="fangjianLiuyanText">
                        <el-input type="textarea"  :readonly="ro.fangjianLiuyanText" v-model="ruleForm.fangjianLiuyanText" placeholder="评论/投诉内容"></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.fangjianLiuyanText" label="评论/投诉内容" prop="fangjianLiuyanText">
    ...
    export default {
        data() {
            return {
                ...
                rules: {
                   ...
                   fangjianLiuyanText: [
                              { required: true, message: '评论/投诉内容不能为空', trigger: 'blur' },
                          ],
                   replyText: [
                              { required: true, message: '回复内容不能为空', trigger: 'blur' },
                          ],
                   insertTime: [
                              { required: true, message: '评论/投诉时间不能为空', trigger: 'blur' },
                          ],
                   updateTime: [
        ...
        created() {
            ...
            if (this.role != "管理员"){
                ...
                this.ro.fangjianLiuyanText = true;//评论/投诉内容
            }
